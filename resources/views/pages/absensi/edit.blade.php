                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('attendances.update', $attendance->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="time" name="time" id="time" class="form-control" value="{{ old('time', $attendance->time) }}" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        @if($attendance->image_url)
                                            <img src="{{ $attendance->image_url }}" alt="Attendance Photo" class="img-fluid" style="max-width: 300px; height: auto;">
                                        @else
